...
- **다중 모델 전략**: **LangChain4j**를 도입하여 정밀 분석에는 `Gemini-2.0-flash`를, 빠른 간략 분석에는 **Groq API**(`llama-3.3-70b`)를 연동하는 등 목적에 맞는 하이브리드 AI 로직을 구축했습니다.
